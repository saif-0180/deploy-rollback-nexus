  ...
  <div className="max-w-7xl mx-auto space-y-6">
    ...
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 min-h-0">
      ...
      <div className="space-y-6 flex flex-col">
        ...
        {/* Steps Management - Fixed height with scrollable steps */}
        <Card className="bg-[#1a2b42] text-[#EEEEEE] border-2 border-[#EEEEEE]/30 flex flex-col max-h-[600px]">
          <CardHeader className="flex-shrink-0">
            <CardTitle className="text-[#F79B72]">Deployment Steps</CardTitle>
          </CardHeader>
          <CardContent className="flex-1 flex flex-col min-h-0 space-y-4">
            {/* Current Steps List - Scrollable */}
            {steps.length > 0 && (
